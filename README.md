...
For an Occupancy Grid Map output from a SLAM algorithm, implement __A star__ path planning algorithm for a specified goal position as a service provider (provide the goal
